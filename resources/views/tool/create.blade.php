@extends('layouts.app', ['title' => __('Create Tool')])

@section('content')
@include('users.partials.header', [
    'title' => __('Create tool'),
    'description' => __('Fill this form to Create a tool, please note that any empty field will be shown as unknown.'),
])   

<div class="container-fluid mt--7">
    <form method="post" action="{{ route('category.tool.store') }}" autocomplete="off" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="input-title" name="title" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}">
                            ...
                            <div class="form-group" id="questions-group">
                                ...
                                <textarea id="input-answers" name="answers[]" class="mytextarea form-control{{ $errors->has('answers') ? ' is-invalid' : '' }}"></textarea>
                            ...
                            <div class="form-group" id="meta_tags-group">
                                ...
                                <textarea name="meta_tags" class="form-control" rows="5"></textarea>
                            ...
                            <div class="form-group" id="js-group">
                                ...
                                <textarea name="js" class="form-control" rows="15"></textarea>

                            </div>

                            <div class="text-center">
                                <button type="submit" class="btn btn-success mt-4">{{ __('Create Tool') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 mt-5 mt-xl-0">
                <div class="card card-profile shadow border-0 rounded overflow-hidden my-sm-5 my-md-0">
                    ...
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4" onclick="document.getElementById('file-input').click();" id="coverImg">
                        <img src="" alt="tool Cover" style="width: 100%;">
                    </div>
