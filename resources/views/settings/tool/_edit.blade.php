@extends('layouts.app', ['title' => __('tool Management')])
...
<div class="container-fluid mt--7">
    <form method="post" action="{{ route('category.tool.store', ['category'=>$tool->category_slug()]) }}" autocomplete="off" enctype="multipart/form-data">
        @csrf
        <div class="row">
            {{-- Form Section --}}
            <div class="col-12">
