<div class="box__content">
    <div class="row row--xs">
        <div class="col-lg-2 col-md-3 col-6" data-groups="['developmentTools']">
            <a class="application" href="/tools#developmentTools">
                ...
                <div class="application__title">
                    <span class="application__title-text">Develoopment</span>
