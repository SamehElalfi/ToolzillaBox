    ...
    <div class="row row--xs justify-content-center">
        @foreach ($categories as $category)
            <div class="col-lg-2 col-md-3 col-6" data-groups="['{{ $category->slug }}']">
                <a class="application" href="{{ route('category.show', $category->slug) }}">
                    ...
                    <img src="{{ $category->cover }}" style=" width: 80%; "></div>
                    <div class="application__title">
                        <span class="application__title-text">{{ $category->name }}</span>
                        <span class="application__title-hovertext">See Tools</span>
                    </div>
        ...
        {{-- <div class="col-lg-2 col-md-3 col-6" data-groups="['securityTools']">
            <a class="application" href="/tools#securityTools">
                ...
                <div class="application__title">
                    <span class="application__title-text">Security</span>
                    <span class="application__title-hovertext">See Tools</span>
                </div>
                <span class="application__hover">
                    <span>
        ...
        <div class="col-lg-2 col-md-3 col-6" data-groups="['cms']">
            <a class="application">
                <div class="application__icon">
        ...
        <div class="col-lg-2 col-md-3 col-6" data-groups="['server']">
            <a class="application">
                <div class="application__icon">
                    <img src="{{ asset('dist/img/coming-soon.png') }}">
                </div>
