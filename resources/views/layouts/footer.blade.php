			...
			<div class="row">
				<div class="footer__column col-md-3">
					...
					<ul class="footer__nav nav">
						...
						<li class="nav__item">
							<a class="nav__link" href="https://www.vultr.com/products/bare-metal/">Development Tools</a>
						</li>
												<li class="nav__item">
							<a class="nav__link" href="https://www.vultr.com/products/object-storage/">Desiging Tools</a>
						</li>
												<li class="nav__item">
							<a class="nav__link" href="https://www.vultr.com/products/block-storage/">Photos Tools</a>
						</li>
						<li class="nav__item">
							<a class="nav__link" href="https://www.vultr.com/products/dedicated-cloud/">Encrytion Tools</a>
						</li>
						<li class="nav__item">
							<a class="nav__link" href="https://www.vultr.com/products/ddos-protection/">Colors Tools</a>
						</li>
						<li class="nav__item">
							<a class="nav__link" href="https://www.vultr.com/products/direct-connect/">All Tools</a>
						</li>
				...
				<div class="footer__column col-md-3">
					...
					<ul class="footer__nav nav">
						<li class="nav__item">
							<a class="nav__link" href="https://www.vultr.com/features/datacenter-locations/">Data Center Locations</a>
						</li>
						
						<li class="nav__item">
							<a class="nav__link" href="https://www.vultr.com/features/control-panel/">Control Panel</a>
						</li>
						<li class="nav__item">
							<a class="nav__link" href="https://www.vultr.com/features/operating-systems/">Operating Systems</a>
						</li>
						
						<li class="nav__item">
							<a class="nav__link" href="https://www.vultr.com/features/one-click-apps/">One-click Apps</a>
						</li>
						<li class="nav__item">
							<a class="nav__link" href="https://www.vultr.com/features/bgp/">Bring your IP space</a>
						</li>
					</ul>
				</div>
				<div class="footer__column col-md-6">
					<h3 class="footer__title h6" data-toggle="footer-column" data-url="/resources" style="
    margin-left: 40px;
...
<form method="post" action="https://www.vultr.com/register/" class="is-hidden-md-down rail show-password-danger password-is-strong" data-ps-strength="">
				<input type="hidden" name="action" value="djJ8cEpzbTNSYXVxaUVBRnJVaEEwNHItRWJQcXdTMUZudk98_O_deGHfyf-mjai9NpEsi-2jKYsTXj9x0yLHlgxtxSpMYjbBsRg">
					...
					<input name="9d9f36261bb4a2e48e8c184b18d7865c" type="email" required="" class="form-control form-control--xlg" placeholder="Email Address" style="
    border-radius: 50px;
">
				</div>
				
				<div class="rail__toolbar" style="
    position: absolute;
    right: 30px;
    border-radius: 50px;
">
					<button class="btn btn--primary btn--lg" type="submit" style="
    border-radius: 50px;
">
						<span class="btn__text">Subscribe</span>
						<span class="btn__preloader preloader"></span>
					<span class="btn-hover-effect"></span><span class="btn-hover-effect"></span><span class="btn-hover-effect" style="left: 143.406px; top: 48px;"></span><span class="btn-hover-effect"></span></button>
				</div>
			</form>
	...
	<div class="footer__bottom">
		<div class="container">
			<div class="footer__brand brand brand--footer">
				<a href="http://www.vultr.com/" class="brand__logo" data-logo="">
		...
		<g transform="translate(-10 -10)">
				...
				<g>
				<path class="svg-logo__shape-1" data-logo-dark-blue="" d="M23.473,9.97C23.105,9.387,22.455,9,21.715,9H11.077C9.929,9,9,9.93,9,11.077C9,11.484,9.117,11.864,9.32,12.185L14.557,20.493000000000002L28.71,18.278000000000002L23.473,9.97Z"></path>
				<path class="svg-logo__shape-2" data-logo-light-blue="" d="M25.655,13.431C25.287000000000003,12.847999999999999,24.636000000000003,12.460999999999999,23.897000000000002,12.460999999999999H13.259C12.112,12.460999999999999,11.182,13.390999999999998,11.182,14.537999999999998C11.182,14.945999999999998,11.299000000000001,15.325,11.502,15.645999999999999L14.557,20.491999999999997L28.709,18.276999999999997L25.655,13.431Z"></path>
			...
			<div class="footer__bottom-nav nav nav--h">
				<li class="nav__item">
					<a class="nav__link" href="https://www.vultr.com/legal/tos/">Terms of Service</a>
				</li>
				<li class="nav__item">
					<a class="nav__link" href="https://www.vultr.com/legal/use_policy/">AUP/DMCA</a>
				</li>
				<li class="nav__item">
					<a class="nav__link" href="https://www.vultr.com/legal/privacy/">Privacy Policy</a>
				</li>
				<li class="nav__item">
					<a class="nav__link" href="https://www.vultr.com/legal/cookie_policy/">Cookie Policy</a>
				</li>
			</div>
		</div>
	</div>
