...
## Log
- finished /contact page and database table
- finished email list form and database table
- fixed links in navbar
- removed scripts from about section and donate section
- changed "Features" to "Most Using" in footer
- finished /about page
- set limit of visits for all routes
- finished /donate page
- organized all routes
